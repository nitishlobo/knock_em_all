...
bowling.o : $(USER_DIR)/bowling.cc $(USER_DIR)/bowling.h $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(USER_DIR)/bowling.cc
...
ball_away : bowling.o acceptance_tests.o gtest_main.a
